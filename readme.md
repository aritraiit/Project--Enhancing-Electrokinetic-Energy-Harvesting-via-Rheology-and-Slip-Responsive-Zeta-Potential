...
- **Partially hydrolyzed polyacrylamide (HPAM):** exhibits $n = 0.426$ for molar concentrations $C[\eta] \le 30$ [Pérez et al. (2024)](https://doi.org/10.1038/s41598-024-79242-0)
- **Sodium carboxymethylcellulose (CMC):** in 0.5 M NaCl under unentangled conditions, with reported $n \approx 0.25-0.37$ [Lopez et al. (2018)](https://doi.org/10.1021/acs.macromol.8b00178)
- **Hyaluronic acid (HA, 1.6 MDa):** at 0.10 wt.% in PBS, showing $n \approx 0.47-0.68$ [Haward et al. (2013)](https://doi.org/10.1063/1.4816708)
